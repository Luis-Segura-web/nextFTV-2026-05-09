...
public class BaseStandardGsyPlayerView extends GSYVideoPlayer {
     ...
     */
    public BaseStandardGsyPlayerView(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public BaseStandardGsyPlayerView(Context context) {
        super(context);
    }

    public BaseStandardGsyPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, BaseStandardGsyPlayerView.this);
        }
        prepareVideo();
    ...
    protected void showProgressDialog(float deltaX, String seekTime, long seekTimePosition, String totalTime, long totalTimeDuration) {
        ...
        if (deltaX > 0) {
            if (mDialogIcon != null) {
                mDialogIcon.setBackgroundResource(R.drawable.ic_player_seek_forward);
            }
        } else {
            if (mDialogIcon != null) {
                mDialogIcon.setBackgroundResource(R.drawable.ic_player_seek_backward);
            }
        }
    ...
    protected void showBrightnessDialog(float percent) {
        if (mBrightnessDialog == null) {
            ...
            int location[] = new int[2];
            getLocationOnScreen(location);
            int rightInset = getSafeRightInset();
            localLayoutParams.x = location[0] + rightInset;
            localLayoutParams.y = location[1];
    ...
    protected int getSafeRightInset() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            return rootInsets.getInsetsIgnoringVisibility(
                WindowInsets.Type.systemBars() | WindowInsets.Type.displayCutout()
            ).right;
        }
        return rootInsets.getSystemWindowInsetRight();
    }
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        BaseStandardGsyPlayerView sf = (BaseStandardGsyPlayerView) from;
        BaseStandardGsyPlayerView st = (BaseStandardGsyPlayerView) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            BaseStandardGsyPlayerView gsyVideoPlayer = (BaseStandardGsyPlayerView) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(BaseStandardGsyPlayerView standardGSYVideoPlayer) {
